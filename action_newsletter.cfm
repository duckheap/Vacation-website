...
<cfinclude template="templates/topbar.cfm">
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Newsletter Confirmation</h1>
    ...
    <cfinsert datasource="newsletter" tablename="recipients"> 
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Newsletter Subscribed</h1>
            </div>

                <div class="wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Thanks for Suscribing to the news letter.</h5>
                    <p class="mb-4"><cfoutput>"#Form.email#" has been subscribed to the newsletter.</cfoutput></p>
                </div>
